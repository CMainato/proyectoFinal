...
var IntroGuard = /** @class */ (function () {
    ...
    IntroGuard.prototype.canActivate = function (next, state) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.storage.get("introCompleted")];
                    case 1:
                        isComplete = _a.sent();
                        if (!isComplete) {
    ...
    IntroGuard.ctorParameters = function () { return [
...
var LoginGuard = /** @class */ (function () {
    ...
    LoginGuard.prototype.canActivate = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.storage.get("isLogged")];
                    case 1:
                        isLogged = _a.sent();
                        if (!isLogged) {
                            this.router.navigateByUrl("/login");
                        }
                        return [2 /*return*/, isLogged];
                }
            });
        });
    };
...
var SongsModalPageModule = /** @class */ (function () {
    function SongsModalPageModule() {
    }
...
var SongsModalPage = /** @class */ (function () {
    function SongsModalPage(modalController, navParams) {
        this.modalController = modalController;
        this.navParams = navParams;
    }
    SongsModalPage.prototype.ionViewDidEnter = function () {
        console.table(this.navParams);
        this.songs = this.navParams.data.songs;
        this.artist = this.navParams.data.artist;
    };
    SongsModalPage.prototype.selectSong = function (song) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.modalController.dismiss(song)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    SongsModalPage.ctorParameters = function () { return [
